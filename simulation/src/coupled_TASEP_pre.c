...
void Jy0y1(int L, int N, int M, int T, double *v_x0_mean, int *x0, double *v_x1_mean, int *x1, double *v_y0_mean, int *y0, double *v_y1_mean, int *y1, double *j_x, double *j_y);
...
void main(int argc, char *argv[])
{
  ...
  FILE *fp,*fp1,*fp2,*fp3,*fp4,*fp5;
    ...
    for(i=0;i<20;i++){
      ...
      Jy0y1(L,N,M,T,&v_x0_mean,&x0[i][0],&v_x1_mean,&x1[i][0],&v_y0_mean,&y0[i][0],&v_y1_mean,&y1[i][0],&j_x,&j_y);
